...
# Counts only ACTIVE agents (jobName exists AND completionTime null) to prevent false positives
# from completed agents or ghost Agent CRs that kro failed to process (issue #189)
